...
<template>
  <nav class="bg-gray-900 rounded-b-2xl">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-around items-center py-6 md:py-8">
        <div class="flex items-center">
          <router-link to="/home" class="flex items-center mr-6">
            <img class="h-20 ml-[-30px]" src="../../public/favicon.ico" alt="Logo" />

          </router-link>
          <div class="hidden md:block">
            <router-link to="/home"
              class="text-red-100 hover:text-red-200 ml-8 px-3 py-2 rounded-md text-lg font-sans transition-colors duration-300"
              ...
              <li v-for="movie in searchResultsWithPoster" :key="movie.id"
                ...
                <router-link :to="{ name: 'overview', params: { id: movie.id } }">
                  <div class="flex justify-center items-center gap-3">
                    <img class="rounded-xl border border-red-300 hover:border-red-400 w-10" :src="getMoviePosterURL(movie.poster_path)" />
